...
from evaluate.shapenet.eval_visual import evaluate
...
configs.dataset.root = 'E:\\datasets\\shapenetcore_partanno_segmentation_benchmark_v0_normal'
...
configs.train.batch_size = 12 # 32
